INSERT INTO lineup_optimized (salary, proj_score, date, players)
SELECT lineup_cost as salary,
lineup_pts as proj_score,
CURDATE() as date,
players
FROM (
select 
CONCAT(PG1,',',PG2, ',',SG1 , ',' , SG2 , ',' , SF1 , ',' , SF2 ,',' , PF1 , ',' , PF2 , ',' , C ) as players,
PG1,
PG1_SALARY,
PG2_SALARY,
PG2,
